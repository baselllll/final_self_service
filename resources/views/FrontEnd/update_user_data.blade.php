                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="row g-2">
                                    <div class="col-4"></div>
                                    <div class="col-4">
                                        <button id="submit_btn_main" style="display: none" class="btn btn-primary w-100 h-100"  type="submit">@lang('messages.Submit_user')</button>
                                    </div>
                                    <div class="col-4"></div>
                                </div>
                            </div>
    ...
    <script>
        ...
        async function checkEmail(){
            ...
            if(response.verified==1){
                ...
                $('#submit_btn_main').css('display', 'block');
                $('#block_phone_number').removeClass('d-none').addClass('d-block');
