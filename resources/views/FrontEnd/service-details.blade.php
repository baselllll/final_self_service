                    ...
                    <form action="{{route('add-service-detail')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                @if($absence_attendance_type_id == \App\Enums\AppKeysProps::WorkPremission_absence_type_id()->value )
                                        <input required type="text" value="{{ $formattedDate }}" class="form-control datepicker" name="start_date" id="start_date" placeholder="Subject">
                                    @elseif($absence_attendance_type_id == \App\Enums\AppKeysProps::PersonnalPremission_absence_type_id()->value)
                                        <input required type="text" value="{{ $formattedDate }}" class="form-control datepicker" name="start_date" id="start_date" placeholder="Subject">
                                    @else
                                        <input required type="text" value="{{ $formattedDate }}" class="form-control datepicker" name="start_date" id="start_date" placeholder="Subject">
                                    @endif
                                ...
                                <div class="form-floating">
                                    @if($absence_attendance_type_id == \App\Enums\AppKeysProps::WorkPremission_absence_type_id()->value )
                                        <input required type="text" value="{{ $formattedDate }}" class="form-control datepicker" name="end_date" id="end_date" placeholder="Subject">
                                    @elseif($absence_attendance_type_id == \App\Enums\AppKeysProps::PersonnalPremission_absence_type_id()->value)
                                        <input required type="text" value="{{ $formattedDate }}" class="form-control datepicker" name="end_date" id="end_date" placeholder="Subject">
                                    @else
                                        <input required type="text" value="{{ $formattedDate }}" class="form-control datepicker" name="end_date" id="end_date" placeholder="Subject">
                                    @endif
                                    <label for="end_date">@lang('messages.End Date')</label>
                                </div>
                                <br/>
                                ...
                                @endif
                                 @if($absence_attendance_type_id==\App\Enums\AppKeysProps::WorkPremission_absence_type_id()->value)
                                    <div id="official_permit_comments" class="form-floating">
                                        <input type="text" id="official_permit_comments" class="form-control" name="official_permit_comments" placeholder="Subject">
                                        <label for="official_permit_comments">@lang('messages.Comments')</label>
                                    </div>
...
@elseif($absence_attendance_type_id == \App\Enums\AppKeysProps::Sickleave_absence_type_id()->value)
    <script>
        $(document).ready(function () {
    ...
    <script>
        $(document).ready(function () {
            $(".datepicker").datepicker({
                ...
                minDate:-5,
                dateFormat: 'yy-mm-dd',
                hourMin: 8, // Minimum hour
                hourMax: 15, // Maximum hour
            });
        });
    </script>
...
@elseif($absence_attendance_type_id == \App\Enums\AppKeysProps::Death_absence_type_id()->value)
    <script>
        $(document).ready(function () {
            $(".datepicker").datetimepicker({
                controlType: 'select',
