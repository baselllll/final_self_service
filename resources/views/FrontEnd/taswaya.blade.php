                            ...
                            <table id="absense_table" class="table table-striped bg-dark" style="width:100%; color: white">
                                ...
                                @foreach($absence_requests as $item)
                                    <tr>
                                        ...
                                        @elseif($item->taswiath_status == 1 or $item->absence_type== \App\Enums\AppKeysProps::Emergency_Leave()->value)
                                            <td>
                                                <a href="{{route("get-details",['transaction_id'=>$item->transaction_id])}}">
                                                    <button  type="button"
                                                             class="btn btn-primary"
                                                    ><i class="fa fa-arrow-up" aria-hidden="true" style="font-size: 28px;"></i></button>
                                                </a>
                                                <a href="#">
                                                    <button
                                                        data-start_date="{{$item->absence_start_date}}"
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                        <h6 class="section-title bg-white text-center text-primary px-3">@lang('messages.Request_approved') </h6>
                    </div>
                    <div class="col-12">
                        <div style=" overflow: auto;">
