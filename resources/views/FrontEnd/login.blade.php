...
<body>
    ...
    <div class="container">
        ...
        <div class="container" id="login_container">
            @if(isset($feature_new) and $feature_new->status=="Active")
                <div class="hot-news section-title  text-center text-danger px-3" id="hot-news">
    ...
    font-size: 30px;
    line-height: 40px;
    font-weight: bold;margin: -52px;">
                        <div class=""> <span style="font-weight: bold;color: black;font-size: 15px;    position: fixed;
    right: 188px;
    top: 70px;">{{$number_of_hits}} </span></div>
                    </div>
