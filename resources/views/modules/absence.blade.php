...
{{--                @endif>--}}
            <tr>
                ...
                <td style="color: white">{{explode(" ",$item->emp_name)[0]  . " " .explode(" ",$item->emp_name)[1]}}</td>
                ...
                <script>
                    console.log("{{$item->mgr_approval_status}}")
                    console.log("{{$pending_status}}")
                    console.log("{{$item->absence_type}}")
                ...
                @else
                    <td style="display: flex;justify-content: space-evenly;">
                        ...
                        <script>
                            // $item->absence_type==\App\Enums\AppKeysProps::Annual_Leave()->value
                            {{--console.log('wewewe'+ "{{$item->absence_type ."sdsd ". \App\Enums\AppKeysProps::Annual_Leave()->value}}")--}}
                        </script>
                        @if($item->absence_type==\App\Enums\AppKeysProps::Annual_Leave()->value)
