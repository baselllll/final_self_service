...
use App\Http\Controllers\BackEndControllers\PortalServicesController;
...
Route::group(['middleware' => 'check.allowed.location'], function () {
    ...
    Route::get('/edit-template/{transition_id}',[\App\Helper\SmsVerifyHelper::class,'EditOnTemplate']);
   ...
   // that to configuring the translation
    ...
    Route::post("update_phone_profile",[LoginController::class,'update_phone_profile'])->name('update_phone_profile');
    ...
    Route::group(['middleware' => 'employee.session'], function () {
        //show the services Available in platform
        Route::get("portal-services",[PortalServicesController::class,'index']);
       ...
       // that 7 routes is responsible for delegation
        ...
        Route::post('update_replacement',[ProfileEmployeeController::class,'update_replacement'])->name("update_replacement");

        //get replacement

        Route::get('get-replacements',[ProfileEmployeeController::class,'get_replacements'])->name('get-replacements');
        Route::post('upload_image',[ProfileEmployeeController::class,'upload_image'])->name('upload_image');
    });
