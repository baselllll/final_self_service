...
class MangerLogicService
{
 ...
 public function GetnotificationOfEmployee($emp_number=null,$person_id=null){
    ...
    public function ApproveRequest($notif_id,$transaction_id,$note,$type,$replacement_no){
        return $this->mainOracleQueryRepo->ApproveRequest($notif_id,$transaction_id,$note,$type,$replacement_no);

    }
    public function xxajmi_leave_prc_next_payroll($transaction_id){
        return $this->mainOracleQueryRepo->xxajmi_leave_prc_next_payroll($transaction_id);
